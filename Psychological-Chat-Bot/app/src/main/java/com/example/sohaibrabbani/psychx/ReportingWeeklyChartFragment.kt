...
import kotlinx.android.synthetic.main.activity_reporting_weekly_chart.*
import java.util.*

class ReportingWeeklyChartFragment : Fragment() {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        activity?.setTitle("Weekly Chart Report")
        piechart_weekly_edit_text_age.setOnClickListener {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                datePickerDialog.setOnDateSetListener { view, year, month, dayOfMonth ->
                    ...
                    piechart_weekly_edit_text_age.setText(date)
                    PsychxWebService().getWeekWiseEmotions(this, userId, date)
                }
            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_reporting_weekly_chart, container, false)
    }
    ...
    fun populatePieChart(anger: Double, disgust: Double, fear: Double,
        ...
        var pieChart = weekly_pie_chart as PieChart
