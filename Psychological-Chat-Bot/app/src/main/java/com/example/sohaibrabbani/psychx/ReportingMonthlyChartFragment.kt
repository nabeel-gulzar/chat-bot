...
class ReportingMonthlyChartFragment : Fragment() {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        activity?.setTitle("Monthly Chart Report")
        piechart_monthly_edit_text_age.setOnClickListener {
...
//            array_percent.add((surprise*percent_ratio).toString() + "%")
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_reporting_monthly_chart, container, false)
    }
